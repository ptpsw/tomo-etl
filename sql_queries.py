...
sdr_table_drop = "DROP TABLE IF EXISTS sdr;"
...
sdr_table_insert = """
INSERT INTO sdr (station_id, timestamp, value)
VALUES (%s, %s, %s)
ON DUPLICATE KEY UPDATE value=VALUES(value);
"""
...
create_table_queries = [
    station_table_create,
    station_link_table_create, 
    max_snr_table_create, sdr_table_create, temp_table_create, current_table_create
]

# Drop tables with tables with foreign key first
drop_table_queries = [
    max_snr_table_drop, sdr_table_drop, temp_table_drop, current_table_drop,
